...
public class SearchItem extends HttpServlet {
	 ...
	 * out.print("<h1>THis is body page</h1>"); out.println("</body></html>");
	 * out.flush(); out.close();
	 * 
	 ...
	 * JSONObject(); JSONObject obj1 = new JSONObject(); JSONArray array = new
	 * JSONArray(); try { array.put(obj.put("username", "sdasd"));
	 * array.put(obj1.put("username", "sdddddd"));
	 * 
